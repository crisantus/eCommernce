...
import com.example.ecommernce.Model.Cart;
import com.example.ecommernce.Prevalent.Prevalent;
import com.example.ecommernce.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter=new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                holder.txtProductQuantiy.setText("Quantity = "+model.getQuantity());
